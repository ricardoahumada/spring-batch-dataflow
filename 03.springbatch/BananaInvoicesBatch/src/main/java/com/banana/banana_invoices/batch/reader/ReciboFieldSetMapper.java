package com.banana.banana_invoices.batch.reader;
...
import static com.banana.banana_invoices.util.BatchUtil.*;
...
public class ReciboFieldSetMapper implements FieldSetMapper<Recibo> {
    ...
    public Recibo mapFieldSet(FieldSet fieldSet) throws BindException {
        ...
        if (isValidField(fieldSet, "id_remoto")) rec.setId(fieldSet.readLong("id_remoto"));
