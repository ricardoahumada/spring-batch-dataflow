package es.netmind.tasksinkdemo.SpringCloudTaskFinal;

import es.netmind.tasksinkdemo.TaskSinkDemoApplication;
...
@SpringBootTest(classes = TaskSinkDemoApplication.class)
